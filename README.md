...
|-------|------|------------------------|------------------------------|
| Gemma3-270M | CLS | +30% (50.3→65.6 ms) | -23% (19.90→15.24 tps) |
| Gemma3-270M | QA | +24% (47.3→58.5 ms) | -19% (21.13→17.10 tps) |
| Gemma3-1B | CLS | +12% (68.5→77.0 ms) | -11% (14.60→12.98 tps) |
| Gemma3-1B | QA | +21% (57.8→69.7 ms) | -17% (17.31→14.36 tps) |
| Gemma3-4B | CLS | +10% (86.1→94.4 ms) | -9% (11.62→10.60 tps) |
| Gemma3-4B | QA | +17% (79.8→93.5 ms) | -14% (12.53→10.70 tps) |
